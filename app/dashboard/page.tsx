  ...
  return (
    <div className="min-h-screen bg-slate-900">
      ...
      <header className="bg-slate-800 shadow-sm sticky top-0 z-50 border-b border-slate-700">
        ...
        {/* 下拉選單 */}
        {showMenu && (
          <div className="absolute right-0 top-full mt-1 w-48 bg-slate-800 rounded-lg shadow-lg border border-slate-700 mr-4 overflow-hidden">
            <button
              onClick={() => {
                setShowAddStockModal(true);
                setShowMenu(false);
              }}
              className="w-full px-4 py-3 text-left hover:bg-slate-700 flex items-center gap-2 border-b border-slate-700"
            >
              <svg className="w-4 h-4 text-slate-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4v16m8-8H4" />
              </svg>
              <span className="text-sm font-medium text-slate-200">新增股票</span>
            </button>
            <button
              onClick={() => {
            ...
            >
              ...
              <span className="text-sm font-medium text-slate-200">關注名單</span>
            </button>
            <button
              onClick={() => {
            ...
            >
              <span className="text-slate-300">📊</span>
              <span className="text-sm font-medium text-slate-200">盤後法人</span>
            </button>
            <button
              onClick={() => {
              ...
              className="w-full px-4 py-3 text-left hover:bg-slate-700 flex items-center gap-2 text-red-400"
            >
